                ...
                $('#coupon_table').DataTable({
                    ...
                    "columnDefs": [
                        ...
                        },
                        {
                            ...
                            "data": "coupon_id",
                            "render": function (data, type, row, meta) {
                                return '<a href="_edit_coupon.php?coupon_id=' + data + '" class="btn btn-info edit_btn" data-coupon_id=' + data + '>編輯</a >';
                            }
                        },
                        {
                            "targets": [11],
                            "data": "coupon_id",
                            "render": function (data, type, row, meta) {
                                return '<button class="btn btn-danger del-btn" data-coupon_id=' + data + '>刪除</button >';
                            }
                        }
                    ],
