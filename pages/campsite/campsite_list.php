                ...
                <tbody class="data_body">
                    <?php foreach ($rows as $row) : ?>
                        <tr style="white-space:nowrap">
                            <td><?= $row['camp_id'] ?></td>
                            <td>
                                <a href="./<?= $row['camp_img'] ?>" data-lightbox="image-1" data-title="<?= $row['camp_name'] ?>">
                                    <img src="./<?= $row['camp_img'] ?>" alt="" height="50">
                                </a></td>
                            <td><?= $row['camp_name'] ?></td>
                            <td><?= $row['city'] ?><?= $row['dist'] ?><?= $row['camp_address'] ?></td>
                            ...
                            <td><?= $row['camp_tel'] ?></td>
                            <td>
                                <a href="#" class="campsite_card mx-1 p-1" data-camp-id="<?= $row['camp_id'] ?>" data-camp-img="<?= $row['camp_img'] ?>" data-camp-name="<?= $row['camp_name'] ?>" data-city="<?= $row['city'] ?>" data-dist="<?= $row['dist'] ?>" data-camp-address="<?= $row['camp_address'] ?>" data-camp-location="<?= $row['camp_location'] ?>" data-camp-intro="<?= $row['camp_intro'] ?>" data-camp-detail="<?= $row['camp_detail'] ?>" data-camp-device="<?= $row['camp_device'] ?>" data-camp-service="<?= $row['camp_service'] ?>" data-camp-notice="<?= $row['camp_notice'] ?>" data-camp-tel="<?= $row['camp_tel'] ?>" data-camp-fax="<?= $row['camp_fax'] ?>" data-camp-email="<?= $row['camp_email'] ?>" data-camp-ownername="<?= $row['camp_ownerName'] ?>" data-camp-opentime="<?= $row['camp_openTime'] ?>" data-camp-target="<?= $row['camp_target'] ?>">
...
<script>
    ...
    $(".data_body").on("click", ".campsite_card", function() {
        ...
        let camp_img = $(this).data("campImg");
                                ...
                                <div class="card-body">
                                    <div class="">
                                        ...
                                        <div class="row px-3 py-1 my-1 border-bottom">
                                            ...
                                            <div class="col-lg-8 p-0 d-flex align-items-center" style="text-align:left;">${city}${dist}${camp_address}</div>
                                        </div>
                                        <div class="row px-3 py-1 my-1 border-bottom">
                                        ...
                                        <div class="row px-3 py-1 my-1 border-bottom">
                                            <div class="col-lg-4 p-0 d-flex align-items-center text-primary">提供設備</div>
                                            <div class="col-lg-8 p-0 d-flex align-items-center ">${camp_device}</div>
                                        </div>
                                        <div class="row px-3 py-1 my-1 border-bottom">
                                            <div class="col-lg-4 p-0 d-flex align-items-center text-primary">附屬服務</div>
                                            <div class="col-lg-8 p-0 d-flex align-items-center ">${camp_service}</div>
                                        </div>
                                        <div class="row px-3 py-1 my-1 border-bottom">
