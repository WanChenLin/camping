                ...
                <form name="form1" method="post" onsubmit="return checkForm()">
                    ...
                    <div class="form">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="camp_name" name="camp_name" placeholder="" value="<?= $camp_name ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="campImg_name" name="campImg_name" placeholder="" value="<?= $campImg_name ?>">
    ...
    $("#button").click(function() {
        let newRow = `<div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" id="camp_image" name="camp_image" value="<?= $camp_image ?>">
                                <img id="myimg" src="./<?= $camp_image ?>" alt="" width="400px"><br>
                                <input type="file" id="my_file" name="my_file"><br>
                            </div>
                        </div>`;
        $("#form").append(newRow);
