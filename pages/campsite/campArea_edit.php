            ...
            <div class="card-body">
                ...
                <form name="form" method="post" onsubmit="return checkForm()" class="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="camp_area" name="camp_area" placeholder="" value="<?= $row['camp_area'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" id="camp_information" name="camp_information" cols="30" rows="3"><?= $row['camp_information'] ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-1">
                            <input type="number" class="form-control" id="camp_number" name="camp_number" placeholder="" value="<?= $row['camp_number'] ?>">
                            <small id="camp_numberHelp" class="form-text text-muted"></small>
                        </div>
                        <label for="camp_size" class="col-form-label text-right">營區尺寸</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="camp_size" name="camp_size" placeholder="" value="<?= $row['camp_size'] ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <input type="number" class="form-control" id="camp_pricew" name="camp_pricew" placeholder="" value="<?= $row['camp_pricew'] ?>">
                        ...
                        <div class="col-sm-2">
                            <input type="number" class="form-control" id="camp_priceh" name="camp_priceh" placeholder="" value="<?= $row['camp_priceh'] ?>">
