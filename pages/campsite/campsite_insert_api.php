...
if (isset($_POST['checkme'])) {
    ...
    $sql = "INSERT INTO `campsite_list`(
       `camp_name`,`camp_address`,`camp_location`, `camp_tel`,`camp_fax`,`camp_email`,`camp_ownerName`, `camp_openTime`,`camp_target`,`city`,`dist`, `camp_intro`,`camp_detail`,`camp_device`,`camp_notice`,`camp_img`,`camp_service`
       ) VALUES ( ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? )";
