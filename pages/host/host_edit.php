...
$sql =  "SELECT * FROM host_list WHERE host_id=$host_id";
    ...
    <aside class="my-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">修改營地主資料</li>
            </ol>
        </nav>
    </aside>
        ...
        <div class="container">
            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <h5 class="card-title">修改營地主資料</h5>
                </div>
                ...
                <form name="formInsert" method="POST" onsubmit="return checkForm()">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="account" name="account" placeholder="" value="<?= $row['host_acc'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" id="password" name="password" placeholder="" value="<?= $row['host_pwd'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" id="password_check" name="password_check" placeholder="" value="<?= $row['host_pwd'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" placeholder="" value="<?= $row['host_incName'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="vatnum" name="vatnum" placeholder="" value="<?= $row['host_incVat'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="tel" name="tel" placeholder="格式：02-2345-6789" value="<?= $row['host_incTel'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="fax" name="fax" placeholder="格式：02-2345-6789" value="<?= $row['host_incFax'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="email" name="email" placeholder="" value="<?= $row['host_incEmail'] ?>">
                    ...
                    <div role="tw-city-selector" data-bootstrap-style data-has-zipcode>
                        <div class="form-group address_api">
                            <div class="row d-flex justify-content-center">
                                <label for="address" class="col-sm-2 col-form-label text-right rwd-text"><span class="asterisk">* </span>地址</label>
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-sm-6 mt-1">
                                    <input type="text" class="form-control flex-grow-1 mt-2" id="address" name="address[]" placeholder="" value="<?= $row['host_incAdd'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="bankname" name="bankname" placeholder="" value="<?= $row['host_bankName'] ?>">
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="bankaccount" name="bankaccount" placeholder="" value="<?= $row['host_bankAcc'] ?>">
