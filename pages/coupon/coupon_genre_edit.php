    ...
    <div class="card-body">
      ...
      <form method="POST" name="coupon_form" onsubmit="return sendForm()">
        ...
        <div class="form-group justify-content-center row">
          ...
          <div class="col-6">
            <input type="text" class="form-control" name="coupon_name" placeholder="輸入coupon名稱" value="<?= $coupon_genre_row['coupon_name'] ?>">
        ...
        <div class="form-group justify-content-center row">
          ...
          <div class="col-6">
            <input type="text" class="form-control" name="discount_unit" id="discount_unit" placeholder="輸入折扣數值" value="<?= $coupon_genre_row['discount_unit'] ?>">
          </div>
        </div>
        <div class="form-group justify-content-center row">
          <label class="col-2 text-right"><span class="asterisk"> *</span>開始領取時間</label>
          <div class="col-6">
            <input type="date" class="form-control" id="avaliable_start" name="avaliable_start" value="<?= $coupon_genre_row['avaliable_start'] ?>" min="2018-01-01" max="">
          </div>
        </div>
        <div class="form-group justify-content-center row">
          <label class="col-2 text-right"><span class="asterisk"> *</span>結束領取時間</label>
          <div class="col-6">
            <input type="date" class="form-control" id="avaliable_end" name="avaliable_end" value="<?= $coupon_genre_row['avaliable_end'] ?>" min="2018-01-01" max="">
          </div>
        </div>
        <div class="form-group justify-content-center row">
          <label class="col-2 text-right"><span class="asterisk"> *</span>到期時間</label>
          <div class="col-6">
            <input type="date" class="form-control" id="coupon_expire" name="coupon_expire" value="<?= $coupon_genre_row['coupon_expire'] ?>" min="2018-01-01" max="">
          </div>
        </div>
        <div class="form-group justify-content-center row">
        ...
        <div class="form-group justify-content-center row">
          ...
          <div class="col-6">
            <input type="text" class="form-control" id="order_price" name="order_price" value="<?= $coupon_genre_row['order_price'] ?>" placeholder="輸入此coupon適用之訂單最低金額">
          </div>
        </div>
        <div class="form-group justify-content-center row">
          <label class="col-2 text-right"></span>訂單天數條件</label>
          <div class="col-6">
            <input type="text" class="form-control" id="order_night" name="order_night" value="<?= $coupon_genre_row['order_night'] ?>" placeholder="輸入此coupon適用之訂單最低天數">
          </div>
        </div>
        <div class="form-group justify-content-center row">
          <label class="col-2 text-right"></span>訂單人數條件</label>
          <div class="col-6">
            <input type="text" class="form-control" id="order_people" name="order_people" value="<?= $coupon_genre_row['order_people'] ?>" placeholder="輸入此coupon適用之訂單最低人數">
          </div>
        </div>
        <div class="form-group justify-content-center row">
          <label class="col-2 text-right"><span class="asterisk"> *</span>優惠券描述</label>
          <div class="col-6">
            <textarea class="form-control" id="discription" name="discription"><?= $coupon_genre_row['discription'] ?></textarea>
          </div>
        </div>
